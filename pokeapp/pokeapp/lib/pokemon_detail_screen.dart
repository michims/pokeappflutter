...
class PokemonDetailScreen extends StatefulWidget {
  ...
  const PokemonDetailScreen(
      {Key key, this.pokemonDetail, this.color, this.heroTag})
      : super(key: key);
  @override
...
class _PokemonDetailScreenState extends State<PokemonDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      //recoge el color de la selección del pokémon
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(
            //el original es por 0,18 pero se ve extraño en mi emulador
            top: height * 0.15,
            left: (width / 2) - 100,
            child: Hero(
              tag: widget.heroTag,
